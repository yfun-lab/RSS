...
const loadRSS = () => {
    ...
    try {
        for (let i = 0; i < config.length; i++) {
            ...
            var res = request('GET', "https://api.rss2json.com/v1/api.json?rss_url=" + encodeURIComponent(rssInfo.url));
            ...
            for (let n = 0; n < rssContent.items.length; n++) {
                let rssData = {
                    ...
                    description: rssContent.items[n].content || rssContent.items[n].description,
